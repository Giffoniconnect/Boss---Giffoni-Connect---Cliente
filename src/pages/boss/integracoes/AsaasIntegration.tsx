  ...
  useEffect(() => {
    async function loadConfig() {
      try {
        ...
        console.error('Erro ao ler Asaas de settings/connectors:', err);
      } finally {
        setLoading(false);
      }
    }
      ...
      <BossLayout>
        <div className="flex-1 p-6 md:p-10 flex items-center justify-center bg-gray-50 text-gray-400">
          <div className="flex flex-col items-center gap-3">
            <div className="w-8 h-8 border-4 border-gray-100 border-t-emerald-700 rounded-full animate-spin"></div>
            <span className="text-xs font-black uppercase tracking-widest text-gray-500">Sincronizando Asaas...</span>
          </div>
        </div>
      </BossLayout>
    );
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-3 mt-1.5">
              <div className="w-10 h-10 bg-emerald-50 text-emerald-750 text-emerald-700 rounded-xl flex items-center justify-center">
                <Landmark size={20} />
              </div>
              <div>
