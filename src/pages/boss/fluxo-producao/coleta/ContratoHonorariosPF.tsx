                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <select
                          ...
                          className="w-full px-3 py-2 bg-white border border-gray-150 rounded-xl text-xs font-semibold text-gray-805 outline-none focus:ring-2 focus:ring-indigo-100"
                        >
