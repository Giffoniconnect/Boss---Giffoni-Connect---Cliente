...
export default function ContratoHonorariosPF() {
  ...
  const handleGenerateContratoGDocs = async () => {
    ...
    addClientLog("CONTR_PF_OFFICIAL_TEMPLATE_SELECTED", `Template oficial de Contrato PF selecionado unicamente como fonte da verdade: ${officialTemplateId}`);
    ...
    try {
      ...
      addClientLog("CONTR_PF_PLACEHOLDERS_BUILT", "Todas as chaves e valores de placeholders foram processados e vinculados com sucesso.");
    } catch (errPl: any) {
