...
export default function ContratoHonorariosPF() {
  ...
  const handleSaveFinancial = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Automatically update cases references is visibleToClient
  ...
  const handleConfirmGDocs = () => {
    setGdocsConfirmed(true);
    setSuccess('Contrato de Honorários gerado via workspace em background!');
    setActiveSubStep(3);
          ...
          <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-150 rounded-3xl p-6 shadow-2xs space-y-6">
                <div className="border-b border-gray-100 pb-3">
                  <h4 className="text-xs font-black text-indigo-950 uppercase tracking-widest flex items-center gap-2">
                    <DollarSign size={18} className="text-indigo-600" /> SubEtapa 1 — Agendar Novo Faturamento
                  </h4>
                  <p className="text-[11px] text-gray-400 mt-1">Configure as metas de faturamento associadas a esse caso jurídico.</p>
                </div>
            ...
            {activeSubStep === 2 && (
              <div className="bg-white border border-gray-150 rounded-3xl p-6 shadow-2xs space-y-6">
                <div className="border-b border-gray-100 pb-3">
                  ...
                  <p className="text-[11px] text-gray-400 mt-1">Espaço visual técnico reservado com antecedência para integração GDocs.</p>
                </div>
            ...
            {activeSubStep === 3 && (
              <div className="bg-white border border-gray-150 rounded-3xl p-6 shadow-2xs space-y-5">
                <div className="border-b border-gray-100 pb-3">
                  <h4 className="text-xs font-black text-indigo-950 uppercase tracking-widest flex items-center gap-2">
                    <FileCheck size={18} className="text-emerald-600" /> SubEtapa 3 — Auditoria Inteligente do Contrato
                  </h4>
