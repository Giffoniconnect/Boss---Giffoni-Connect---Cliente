...
import { ArrowLeft, ArrowRight, Save, Info, ShieldCheck, FileText } from 'lucide-react';
...
export default function ProtocoloFluxo() {
  ...
  return (
    <FluxoStepLayout stepName="Protocolo" caseId={safeCaseId}>
      <div className="space-y-8">
        <div>
          <h3 className="text-xl font-extrabold text-gray-900 tracking-tight">Criação Judicial / Protocolo Administrativo</h3>
          <p className="text-xs text-gray-500 mt-1">
            Geração fática do número definitivo do caso e indexação direta nos órgãos públicos.
          </p>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-150 rounded-2xl p-6 flex gap-4 items-start">
          ...
          <div>
            <h4 className="font-bold text-sm text-gray-900 tracking-tight">Sincronização de Trâmites</h4>
            <p className="text-xs text-gray-400 leading-relaxed mt-1">
              Assim que homologado, o número do processo é injetado automaticamente nos relatórios de integridade dos setores operacionais.
            </p>
          </div>
        </div>
