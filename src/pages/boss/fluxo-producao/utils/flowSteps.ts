...
export const flowSteps: FlowStep[] = [
  ...
  { id: 'protocolo', label: 'Protocolo / Distribuição', routeKey: 'protocolo', requiresCaseId: true, order: 11 },
  { id: 'compliance', label: 'Compliance', routeKey: 'compliance', requiresCaseId: true, order: 12 },
  { id: 'relatorio-integridade', label: 'Relatório de Integridade e Auditoria', routeKey: 'relatorioIntegridade', requiresCaseId: true, order: 13 },
  { id: 'controladoria', label: 'Controladoria', routeKey: 'controladoria', requiresCaseId: true, order: 14 },
  { id: 'arquivamento', label: 'Arquivamento', routeKey: 'arquivamento', requiresCaseId: true, order: 15 },
  { id: 'recadastramento', label: 'Recadastramento', routeKey: 'recadastramento', requiresCaseId: false, order: 16 },
];
