...
export const flowSteps: FlowStep[] = [
  ...
  { id: 'protocolo', label: '14. Protocolo / Distribuição', routeKey: 'protocolo', requiresCaseId: true, order: 14 },
  { id: 'controladoria', label: '15. Controladoria', routeKey: 'controladoria', requiresCaseId: true, order: 15 },
  { id: 'prazos', label: '16. Prazos', routeKey: 'prazos', requiresCaseId: true, order: 16 },
  { id: 'agendar-audiencias', label: '17. Audiências', routeKey: 'agendarAudiencias', requiresCaseId: true, order: 17 },
