...
export const flowSteps: FlowStep[] = [
  ...
  { id: 'onboarding', label: 'Onboarding ✈️', routeKey: 'onboarding', requiresCaseId: true, order: 2 },
  { id: 'dados-caso', label: '1.3/1.3.1 Entrevista (5W2H)', routeKey: 'dadosCaso', requiresCaseId: true, order: 3 },
  { id: 'tipo-producao', label: '1.3.2 Tipo de Serviço', routeKey: 'tipoServico', requiresCaseId: true, order: 4 },
  { id: 'financeiro', label: 'Financeiro (Faturamento)', routeKey: 'financeiro', requiresCaseId: true, order: 5 },
  { id: 'solicitacoes-provas', label: '1.4 Coletar Provas', routeKey: 'solicitacoesProvas', requiresCaseId: true, order: 6 },
  { id: 'digitalizacao-upload', label: '1.5 Digitalização & Upload', routeKey: 'digitalizacaoUpload', requiresCaseId: true, order: 7 },
  ...
  { id: 'solicitacoes-provas-adicionais', label: 'Solicitar ➕ Provas', routeKey: 'solicitacoesProvasAdicionais', requiresCaseId: true, order: 13 },
  ...
  { id: 'arquivamento', label: '21. Arquivamento', routeKey: 'arquivamento', requiresCaseId: true, order: 21 },
];
